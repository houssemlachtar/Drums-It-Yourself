$(function() {
    // Crash varibles
    crashCymbolAll = $('#Crash, .Crash');
    crashCymbol = $('#Crash-Cymbol, .Crash-Cymbol');
    ...
    rightTomDrumAll = $('#Tom-Right-All, .Tom-Right-All');
    ...
    leftTomDrumAll = $('#Tom-Left-All, .Tom-Left-All');
    leftTomDrum = $('#Tom-Left-Drum, .Tom-Left-Drum');
    ...
    floorTomDrumAll = $('#Floor-Tom, .Floor-Tom');
    ...
    // Snare drum varibles
    snareDrumAll = $('#Snare, .Snare');
    snareDrum = $('#Snare-Drum, .Snare-Drum');
    ...
    // Hi-hat varibles
    hiHatAll = $('#Hi-Hat, .Hi-Hat');
    hiHatTop = $('#Hi-Hat-Top, .Hi-Hat-Top');
